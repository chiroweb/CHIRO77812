          ...
          <div className="flex border-b border-[#e5e5e3] overflow-x-auto">
            {services.map((service) => (
              <button
                ...
                className={`relative px-6 py-4 text-[13px] tracking-[0.1em] uppercase whitespace-nowrap transition-colors duration-300 cursor-pointer ${
          ...
          >
            ...
            <div className="grid grid-cols-4 md:grid-cols-12 gap-6 mb-16">
              <div className="col-span-4 md:col-span-5">
                <h2 className="text-2xl md:text-[32px] font-light tracking-tight leading-[1.3] mb-6">
                  {activeService.title}
                </h2>
            ...
            {/* Target Cards */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[1px] bg-[#e5e5e3]">
        ...
        <div className="mt-32">
          ...
          <div className="pt-32">
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={viewportConfig}
              className="grid grid-cols-1 md:grid-cols-4 gap-[1px] bg-[#e5e5e3]"
            >
              {processSteps.map((step) => (
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-xs tracking-wider text-[#9b9b9b] font-[family-name:var(--font-jetbrains-mono)]">
                      {step.number}
                    </span>
                    <span className="text-xs tracking-[0.1em] uppercase text-[#9b9b9b]">
                      {step.en}
                    </span>
                  </div>

                  <h3 className="text-lg font-normal tracking-tight mb-3">
                    {step.title}
                  </h3>
                  ...
                  <div className="pt-4 border-t border-[#e5e5e3]">
                    <p className="text-xs tracking-[0.2em] uppercase text-[#9b9b9b] mb-1">
                      소요 시간
                    </p>
                    <p
                      className={`text-sm font-[family-name:var(--font-jetbrains-mono)] tracking-wide ${
                        step.highlight ? "text-[#1a1a1a]" : "text-[#6b6b6b]"
                      }`}
                    >
                      {step.duration}
                    </p>
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={viewportConfig}
              className="mt-16 border border-[#e5e5e3] p-8 md:p-12"
            >
              <div className="grid grid-cols-4 md:grid-cols-12 gap-6">
                <div className="col-span-4 md:col-span-5">
                  ...
                  <h3 className="text-xl md:text-2xl font-light tracking-tight leading-[1.3]">
                    시안을 기다리지 않습니다.
                    <br />
                    과정을 지켜봅니다.
                  </h3>
                ...
                <div className="col-span-4 md:col-span-5 md:col-start-7 flex items-center">
                  <div className="space-y-4 text-sm text-[#6b6b6b] leading-[1.7]">
                    <p>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 relative">
                ...
                {plans.map((plan) => (
                  ...
                  >
                    <p className="text-xs tracking-[0.2em] uppercase text-[#9b9b9b] mb-2">
                      {plan.name}
                      {plan.name === "Business" && (
                        <span className="ml-2 text-[#FF4D00]">Recommended</span>
                      )}
                    </p>
                    <p className="text-2xl md:text-3xl font-light tracking-tight font-[family-name:var(--font-jetbrains-mono)] mb-2">
                      {plan.price}
                    </p>
