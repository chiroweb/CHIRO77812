...
const faqs = [
  ...
  },
  {
    ...
    a: "치로는 빌더를 사용하지 않습니다. 모든 코드를 직접 작성합니다. 구조화 데이터, llms.txt, 커스텀 애니메이션 같은 핵심 요소는 빌더로 구현할 수 없습니다.",
  },
  {
    q: "디자인 시안을 따로 받나요?",
  ...
  {
    q: "수정 횟수에 제한이 있나요?",
    a: "없습니다. 수정 횟수 무제한. 만족할 때까지 피드백을 반영합니다.",
  },
  {
    q: "유지보수는 어떻게 되나요?",
  ...
  {
    q: "해외 사이트도 제작 가능한가요?",
    a: "가능합니다. 영문 사이트, 다국어 사이트 모두 제작 경험이 있습니다. 해외 호텔 브랜드 계열사 프로젝트도 수행했습니다.",
  },
];
