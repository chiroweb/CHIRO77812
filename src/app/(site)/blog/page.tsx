        ...
        >
          {posts.map((post, index) => (
            <motion.div key={post.id} variants={fadeInUp}>
              <Link
                href={`/blog/${post.slug}`}
                className="group block py-10 border-b border-[#e5e5e3]"
              >
                <div className="grid grid-cols-4 md:grid-cols-12 gap-6 items-start">
                  ...
                  <div className="col-span-4 md:col-span-7">
                    ...
                    <h2 className="text-xl md:text-2xl font-normal tracking-tight mb-3 group-hover:opacity-50 transition-opacity duration-300">
                      {post.title}
                    </h2>
