...
const personJsonLd = {
  ...
  description:
    "심리학 전공 디렉터. 기획부터 디자인, 개발, SEO/AEO 최적화까지 직접 주도해 진행하는 AEO·SEO 통합 설계 웹 스튜디오 치로웹디자인의 창립자.",
...
const historyItems = [
  {
    year: "2024",
    tags: ["Foundation"],
    desc: "치로웹디자인 설립. 심리학 전공 디렉터가 주도하는 소수 정예 웹 스튜디오로 시작.",
  },
  {
    year: "2024",
    tags: ["Launch", "Brand"],
  ...
  },
  {
    year: "2026",
    tags: ["SEO/AEO", "AI"],
    desc: "SEO/AEO 통합 설계 시스템 고도화. llms.txt 표준 조기 도입.",
  },
];
...
const aboutFaqs = [
  {
    q: "회사 이름 '치로(CHIRO)'에는 어떤 의미가 있나요?",
    a: "라틴어 'chiro-'는 '손으로 직접'을 뜻합니다. 빌더·자동 생성이 아니라 손으로 직접 코드를 작성한다는 작업 방식을 회사 이름으로 박아 둔 셈입니다. 디렉터의 심리학 전공과도 어울리는 단어로 선택했습니다.",
  },
  {
    q: "소수 정예 스튜디오인데 품질이 균일한가요?",
    a: "기획부터 개발까지 디렉터가 일관되게 진행하기 때문에 커뮤니케이션 비용이 없고 품질이 균일합니다. 해외 호텔 브랜드 계열사, 중견 제조사 같은 까다로운 프로젝트도 수행했습니다.",
  },
  {
    q: "심리학 기반 설계는 구체적으로 어떻게 작업에 반영되나요?",
    a: "인지 심리학의 시각 위계, 결정 피로, 손실 회피 원리를 페이지 흐름에 적용합니다. CTA 위치, 가격 표시 순서, 후기 배치, 폼 필드 개수 같은 모든 결정에 근거가 붙습니다. '느낌'이 아니라 '이유'로 디자인합니다.",
  },
  {
    q: "디렉터의 심리학 백그라운드는 작업에 어떤 영향을 주나요?",
    a: "심리학은 '사람이 어떻게 결정하는가'를 다루는 학문입니다. 디자이너 백그라운드는 '예쁘게'를 우선하지만, 심리학 백그라운드는 '왜 누르게 되는가'를 먼저 봅니다. 같은 시각 결정이라도 출발점이 다릅니다.",
  },
  {
    q: "치로가 거절하는 프로젝트도 있나요?",
    a: "있습니다. 단순 템플릿 복제, 단가만 맞추려는 빌더 이식, 단기 행사용 1회성 페이지는 받지 않습니다. 코드 기반·검색 구조·운영 가능성이 의미를 갖는 프로젝트에 집중합니다.",
  },
  {
    q: "치로의 제작 철학을 한 줄로 정리하면?",
    a: "'예쁜 홈페이지가 아니라 일하는 홈페이지'를 만듭니다. 시안 합의가 아닌 실제 성과(검색 노출·문의 전환)로 결과를 평가합니다.",
  },
];
