    ...
    <section className="pt-32 pb-32 px-8">
      <div className="max-w-[1280px] mx-auto">
        ...
        >
          <motion.h1
            variants={fadeInUp}
            className="text-3xl md:text-[40px] font-light tracking-tight leading-[1.2]"
          >
            디렉터의 편지.
          </motion.h1>
        </motion.div>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={viewportConfig}
          className="mt-20 grid grid-cols-4 md:grid-cols-12 gap-6"
        >
          {/* Photo */}
          <motion.div
            variants={fadeInUp}
          ...
          >
            <div className="sticky top-24">
              ...
              <p className="mt-4 text-xs tracking-[0.2em] uppercase text-[#9b9b9b]">
                Director
              </p>
          ...
          <div className="grid grid-cols-4 md:grid-cols-12 gap-6">
            {[
              ...
              <motion.div
                key={value.title}
                variants={fadeInUp}
                className="col-span-4 border-t border-[#e5e5e3] pt-8"
              >
