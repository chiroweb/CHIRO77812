...
export const services: ServiceDetail[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: 'SEO 세팅 후 효과가 나타나기까지 얼마나 걸리나요?',
        answer: '구조화 데이터와 사이트맵 제출 후, 일반적으로 2~4주 내에 검색 인덱싱이 시작됩니다. 키워드 경쟁도에 따라 순위 상승에는 1~3개월이 소요될 수 있습니다.',
      },
      {
        question: '기존 홈페이지에도 SEO/AEO 세팅이 가능한가요?',
        answer: '네, 기존 사이트의 코드에 구조화 데이터, 메타태그, 사이트맵을 추가하는 방식으로 진행합니다. 사이트 플랫폼(워드프레스, 카페24 등)에 따라 적용 방법이 달라지며, 상담 시 구체적으로 안내드립니다.',
      },
      {
