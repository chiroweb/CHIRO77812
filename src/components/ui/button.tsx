...
export default function Button({
  ...
  const variants = {
    outline:
      "border border-[#1a1a1a] text-[#1a1a1a] px-8 py-3 hover:bg-[#1a1a1a] hover:text-white",
    ghost:
      "border border-[#1a1a1a] text-[#1a1a1a] px-8 py-3 hover:bg-[#FF4D00] hover:text-white hover:border-[#FF4D00]",
