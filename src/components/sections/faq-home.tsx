...
const faqs = [
  {
    q: "치로웹디자인은 어떤 회사인가요?",
    a: "치로웹디자인은 AEO 자동화를 기본 제공하는 코드 기반 웹 에이전시입니다. 심리학 전공의 디렉터가 기획부터 디자인, 개발, 검색 최적화까지 1인 전담하는 올인원 체제로 운영되며, 런칭 4개월 만에 해외 호텔 브랜드 계열사 사이트와 중견 제조사, 환경 기업의 프로젝트를 수주하며 검증된 에이전시입니다.",
  },
  {
  ...
  {
    q: "SEO/AEO 자동화 세팅에는 무엇이 포함되나요?",
    a: "치로의 모든 프로젝트에는 AEO 자동화 파이프라인이 기본 내장됩니다. Organization 스키마, FAQPage 스키마, BreadcrumbList 스키마, 클린 URL 구조, 시맨틱 HTML, 메타 태그 최적화, sitemap.xml, robots.txt, 그리고 AI 검색 엔진 전용 표준인 llms.txt까지 포함됩니다. 별도 견적 없이 제작 비용 안에 모두 포함되며, 구글, ChatGPT, Perplexity가 사이트를 정확히 인식할 수 있도록 코드 레벨에서 설계됩니다.",
  },
  {
    q: "AEO가 무엇이고 왜 중요한가요?",
  ...
  },
  {
    ...
    a: "치로의 평균 제작 기간은 약 3.8일입니다. 일반 에이전시가 4-8주가 걸리는 이유는 상담, 기획서 작성, 시안 제작, 수정, 재확인을 순차적으로 진행하기 때문입니다. 치로는 상담 당일 실시간 빌드를 시작하고, 클라이언트가 링크를 통해 제작 과정을 직접 확인하면서 수정사항을 즉시 반영하는 방식으로 일정을 단축합니다.",
  },
  {
