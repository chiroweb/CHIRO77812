...
const faqs = [
  {
    q: "치로웹디자인은 어떤 회사인가요?",
    a: "치로웹디자인은 심리학 전공의 디렉터가 기획부터 디자인, 개발, 검색 최적화까지 1인 전담하는 올인원 웹 에이전시입니다. SEO와 AEO 자동화 세팅을 기본 포함하며, 런칭 4개월 만에 해외 호텔 브랜드 계열사 사이트와 중견 제조사, 환경 기업의 프로젝트를 수주하며 검증된 에이전시입니다.",
  },
  {
  ...
  },
  {
    ...
    a: "치로의 모든 프로젝트에는 Organization 스키마, FAQPage 스키마, BreadcrumbList 스키마, 클린 URL 구조, 시맨틱 HTML, 메타 태그 최적화, sitemap.xml, robots.txt, 그리고 2026년 신규 표준인 llms.txt가 기본 포함됩니다. 별도 견적 없이 제작 비용 안에 모두 포함되며, 구글, ChatGPT, Perplexity가 사이트를 정확히 인식할 수 있도록 코드 레벨에서 설계됩니다.",
  },
  {
    q: "AEO가 무엇이고 왜 중요한가요?",
